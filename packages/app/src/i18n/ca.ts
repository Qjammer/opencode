export const dict = {
  ...
  "desktop.recovery.unresponsive.detail": "Podeu tornar a iniciar l'aplicació, obrir els registres o continuar esperant.",
  ...
  "help.tabs.toast.ariaLabel":
    "Presentació de les pestanyes. Organitzeu la feina i les sessions actives amb pestanyes",
  "help.tabs.toast.dismiss": "Ignora la informació de les pestanyes",
  "help.tabs.title": "Presentació de les pestanyes",
  "help.tabs.description": "Organitzeu la feina i les sessions actives amb pestanyes",
  "help.tabs.date": "14 de juliol",
  "help.tabs.introduction": "OpenCode L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
    "Inicieu una sessió nova en una pestanya o obriu una sessió existent des de qualsevol dels vostres projectes. Obriu una pestanya nova quan comenceu una cosa nova i tanqueu-la quan hàgiu acabat.",
  "help.tabs.organize":
  ...
  "help.tabs.worktrees":
    "El nou disseny encara no és compatible amb els arbres de treball de Git; arribarà aviat. Per tant, si preferiu continuar utilitzant el disseny anterior, podeu canviar entre els dissenys a Configuració. Tingueu en compte que el nou disseny esdevindrà permanent d'aquí a unes setmanes.",
  ...
  "dialog.project.edit.worktree.startup.description": "S'executa després de crear un nou espai de treball (arbre de treball).",
  ...
  "session.followupDock.expand": "Expandeix els missatges de la cua",
  ...
  "session.revertDock.expand": "Expandeix els missatges revertits",
  ...
  "session.share.popover.title": "Publica al web",
  ...
  "session.share.action.unpublish": "Deixa de publicar",
  ...
  "settings.general.row.newInterface.description":
    "Utilitzeu les pestanyes noves i el disseny de la pantalla d'inici. Canvieu entre dissenys durant un temps limitat.",
  ...
  "settings.general.row.newInterfaceNotice.dismiss": "Descarta",
  ...
  "settings.updates.row.check.description":
    "Comproveu manualment si hi ha actualitzacions i instal·leu-les si n'hi ha",
